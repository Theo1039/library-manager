# book_marker.py - Role 4: The Read-Tracker
def mark_as_read(library: list):
    """Lets the user pick a book, mark it as read, and rate it 1-5 stars.
    ...
    # Prints a numbered list of books
    print("\n📚 Your Library:")
    print("-" * 40)

    # changed the for loop to enumerate to get the index and book
    ...
    # Asks the user for a book number with validation
    while True:
